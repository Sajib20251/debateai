...
document.addEventListener('DOMContentLoaded', () => {
    ...
    async function startDebate() {
        ...
        try {
            ...
            const agreePromptP1 = `তুমি একজন দক্ষ বক্তা। "${topic}" এই বিষয়ের পক্ষে জোরালো যুক্তি দাও।`;
            const agreeArgP1 = await callGroqAPI(MODEL_MAP[agreeModel] || agreeModel, agreePromptP1, "আপনি একজন বিতার্কিক যিনি বিষয়ের পক্ষে যুক্তি দিচ্ছেন।");
            appendToTranscript("প্রথম পর্ব", `পক্ষে (${agreeModel})`, agreeArgP1);
            debateTranscript += `প্রথম পর্ব - পক্ষে (${agreeModel}):\n${agreeArgP1}\n\n`;

            const disagreePromptP1 = `তুমি একজন দক্ষ বক্তা। "${topic}" এই বিষয়ের বিপক্ষে জোরালো যুক্তি দাও।`;
            const disagreeArgP1 = await callGroqAPI(MODEL_MAP[disagreeModel] || disagreeModel, disagreePromptP1, "আপনি একজন বিতার্কিক যিনি বিষয়ের বিপক্ষে যুক্তি দিচ্ছেন।");
            ...
            const agreeRebuttalPrompt = `"${disagreeArgP1}" - প্রতিপক্ষের এই যুক্তির জবাবে "${topic}" বিষয়ের পক্ষে তোমার খণ্ডন দাও।`;
            const agreeRebuttalP2 = await callGroqAPI(MODEL_MAP[agreeModel] || agreeModel, agreeRebuttalPrompt, "আপনি একজন বিতার্কিক যিনি প্রতিপক্ষের যুক্তির খণ্ডন করছেন।");
            appendToTranscript("দ্বিতীয় পর্ব", `পক্ষে (${agreeModel})`, agreeRebuttalP2);
            debateTranscript += `দ্বিতীয় পর্ব - পক্ষে (${agreeModel}):\n${agreeRebuttalP2}\n\n`;

            const disagreeRebuttalPrompt = `"${agreeArgP1}" - প্রতিপক্ষের এই যুক্তির জবাবে "${topic}" বিষয়ের বিপক্ষে তোমার খণ্ডন দাও।`;
            const disagreeRebuttalP2 = await callGroqAPI(MODEL_MAP[disagreeModel] || disagreeModel, disagreeRebuttalPrompt, "আপনি একজন বিতার্কিক যিনি প্রতিপক্ষের যুক্তির খণ্ডন করছেন।");
            ...
            const agreeResponsePromptP3 = `"${disagreeRebuttalP2}" - প্রতিপক্ষের এই খণ্ডনের জবাবে "${topic}" বিষয়ের পক্ষে তোমার জবাব দাও।`;
            const agreeResponseP3 = await callGroqAPI(MODEL_MAP[agreeModel] || agreeModel, agreeResponsePromptP3, "আপনি একজন বিতার্কিক যিনি খণ্ডনের জবাব দিচ্ছেন।");
            appendToTranscript("তৃতীয় পর্ব", `পক্ষে (${agreeModel})`, agreeResponseP3);
            debateTranscript += `তৃতীয় পর্ব - পক্ষে (${agreeModel}):\n${agreeResponseP3}\n\n`;

            const disagreeResponsePromptP3 = `"${agreeRebuttalP2}" - প্রতিপক্ষের এই খণ্ডনের জবাবে "${topic}" বিষয়ের বিপক্ষে তোমার জবাব দাও।`;
            const disagreeResponseP3 = await callGroqAPI(MODEL_MAP[disagreeModel] || disagreeModel, disagreeResponsePromptP3, "আপনি একজন বিতার্কিক যিনি খণ্ডনের জবাব দিচ্ছেন।");
            ...
            const judgePrompt = `নিম্নে একটি বিতর্কের সম্পূর্ণ প্রতিলিপি দেওয়া হলো। বিতর্কের বিষয় "${topic}". বিচারক হিসেবে, যুক্তি, খণ্ডন ও উত্তরের মান বিচার করে কে জিতেছে এবং কেন—এটি নিরপেক্ষভাবে সংক্ষেপে বাংলা ভাষায় জানাও।`;
            const verdict = await callGroqAPI(MODEL_MAP[judgeModel] || judgeModel, judgePrompt, "আপনি একজন নিরপেক্ষ বিচারক যিনি একটি বিতর্ক বিচার করছেন।");
